...
export const BOOKING_FIELDS: EodField[] = [
  { key: "dials", label: "Dials", hint: "phone call attempts that day — every attempt counts, incl. no-answers", optional: false },
  { key: "pickUps", label: "Pick ups", hint: "dials where a human answered and you spoke", optional: false },
  { key: "sets", label: "Sets", hint: "new sales calls you booked that day — prospect committed, time locked in", optional: false },
  ...
  { key: "callsOnCalendar", label: "Calls on the calendar", hint: "first consults from YOUR sets that were scheduled for that day", optional: true },
  { key: "callsShown", label: "Calls shown", hint: "of those, how many showed — follow-ups / second calls don't count", optional: true },
