...
// ==================== (Role Play Rooms / breakouts removed in v1.15) ====================
// The breakouts feature was replaced by inline role-play in the main room
// (coach spotlights 2 attendees, who share the top slot). Removing breakouts
// dropped ~150 lines of action code, eliminated sub-room lifecycle bugs, and
// matched how coaches actually run role-plays — inline, observable by the
// full class, not isolated in side rooms.

// (The previous startBreakouts action + its comment header used to live here.
// See git history at tag personal-v1.14.1 if you need the removed code.)
