...
eq("roll cdplc (cash per live call)", t.cdplc, 1204.8, 0.001);
eq("row cdplc (Closer 1)", mod.roll([SEED[0]], CPC).cdplc, 1694.4444, 0.001);
eq("cdplc zero live → null", mod.roll([{ ...SEED[0], live: 0 }], CPC).cdplc, null);
