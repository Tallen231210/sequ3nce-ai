...
const G = {
  ...
  onCal: { label: "Calls on calendar", hint: "Credited bookings whose call falls in the range. Filed: calls on the calendar." },
  ...
  speed: { label: "Speed to lead", hint: "Median working hours from a lead's arrival to this setter's first touch." },
  bookings: { label: "Bookings", hint: "Bookings whose call falls in the range, credited by the booking link." },
  newSelfBooks: { label: "New self-books", hint: "Self-booked funnel calls made in the range. Filed: new self-booked calls." },
  ...
  response: { label: "Response time", hint: "Median working hours from the self-booking to the first touch." },
