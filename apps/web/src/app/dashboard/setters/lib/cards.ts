...
const G = {
  ...
  speed: { label: "Speed (working)", hint: "Median working hours from a lead's arrival to this setter's first touch, nights and weekends off the clock. Self-booked leads excluded." },
  speedClock: { label: "Speed (clock)", hint: "The same leads on the wall clock — what the prospect actually waited." },
