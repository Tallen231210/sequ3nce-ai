  ...
  if (events.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-16 text-center">
        ...
        <h3 className="text-[15px] font-medium text-gray-600 mb-1">No upcoming meetings</h3>
        <p className="text-[13px] text-gray-400">Your calendar is clear for the next 7 days</p>
      </div>
    );
  }
