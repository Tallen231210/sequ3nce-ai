          ...
          {autoStats ? (
            <>
              <div className="flex items-center gap-2 mb-3">
                <svg className={"w-4 h-4 " + (isVip ? "text-yellow-500" : "text-emerald-500")} viewBox="0 0 24 24" fill="currentColor">
                ...
                <span className={"text-[12px] font-semibold " + (isVip ? "text-yellow-600 dark:text-yellow-400" : "text-emerald-600 dark:text-emerald-400")}>
                  {isVip ? "Gold Verified by Sequ3nce — VIP" : "Verified by Sequ3nce"}
                </span>
              </div>
