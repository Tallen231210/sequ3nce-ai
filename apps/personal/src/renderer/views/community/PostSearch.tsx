  ...
  return (
    <div className="h-full flex flex-col">
      ...
      <div className="flex items-center gap-3 mb-4">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full pl-9 pr-3 py-2 text-sm border border-gray-200 dark:border-zinc-600 rounded-lg bg-white dark:bg-zinc-900 text-gray-900 dark:text-white placeholder:text-gray-400 dark:placeholder:text-zinc-500 focus:outline-none focus:ring-2 focus:ring-black/10 dark:focus:ring-white/10"
            autoFocus
          />
        </div>
        <button
      ...
      <div className="flex-1 overflow-y-auto space-y-3">
        {loading && (
          <div className="text-sm text-gray-400 dark:text-zinc-500 text-center py-8">Searching...</div>
        )}
