...
export function DirectMessagesView({
  ...
  return (
    <div className="flex h-full">
      ...
      <div className="w-[280px] border-r border-gray-200 dark:border-zinc-700 flex flex-col">
        {/* Header */}
        ...
        <div className="px-3 py-2">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-8 pr-3 py-1.5 border border-gray-200 dark:border-zinc-700 rounded-lg text-xs bg-white dark:bg-zinc-800 text-gray-900 dark:text-white placeholder:text-gray-400"
            />
          </div>
        </div>
        ...
        <div className="flex-1 overflow-y-auto">
          {loadingThreads ? (
            <div className="text-xs text-gray-400 dark:text-zinc-500 text-center py-8">
              Loading...
            </div>
        ...
        {showConversation ? (
            ...
            <div className="px-4 py-3 border-t border-gray-200 dark:border-zinc-700">
              <div className="flex items-end gap-2">
                <textarea
                  ...
                  rows={1}
                  className="flex-1 resize-none border border-gray-200 dark:border-zinc-700 rounded-lg px-3 py-2 text-sm bg-white dark:bg-zinc-800 text-gray-900 dark:text-white placeholder:text-gray-400 focus:outline-none focus:ring-1 focus:ring-black dark:focus:ring-white"
                  style={{ maxHeight: 120 }}
                />
                <button
                  onClick={handleSend}
          ...
          <div className="flex-1 flex items-center justify-center">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-500 dark:text-zinc-400">Select a conversation or start a new one</p>
            </div>
          </div>
        )}
      </div>
      ...
      <div className="relative group max-w-[70%]">
        <div
          className={`px-3 py-2 rounded-2xl text-sm ${
            message.isDeleted
              ? 'bg-gray-100 dark:bg-zinc-800 text-gray-400 dark:text-zinc-500 italic'
              : isMine
        ...
        {/* Timestamp */}
        <div className={`text-[10px] text-gray-400 dark:text-zinc-500 mt-0.5 ${isMine ? 'text-right' : 'text-left'}`}>
          ...
          <div className="absolute top-0 -left-6 opacity-0 group-hover:opacity-100 transition-opacity">
            ...
            {showMenu && (
              <>
                ...
                <div className="absolute left-0 top-6 z-20 bg-white dark:bg-zinc-700 border border-gray-200 dark:border-zinc-600 rounded-lg shadow-lg py-1 min-w-[100px]">
                  <button
                    onClick={() => { onDelete(message._id); setShowMenu(false); }}
                    className="w-full text-left px-3 py-1.5 text-xs text-red-600 dark:text-red-400 hover:bg-gray-100 dark:hover:bg-zinc-600"
                  >
                    Delete
                  </button>
                </div>
