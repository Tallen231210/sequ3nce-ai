...
export function HighlightReelEditor({ userId }: HighlightReelEditorProps) {
  ...
  if (isLoading) {
    return (
      <div className="flex items-center gap-2 py-4">
        ...
        <span className="text-[13px] text-gray-500 dark:text-gray-400">Loading clips...</span>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-3">
      ...
      {/* Empty state */}
      {clips.length === 0 && (
        <div className="py-6 px-4 text-center bg-gray-50 dark:bg-gray-800/50 rounded-xl border border-gray-200 dark:border-gray-700">
          ...
          <p className="text-[13px] text-gray-500 dark:text-gray-400">
            ...
            <span className="font-medium text-gray-700 dark:text-gray-300"> &quot;Add to Reel&quot; </span>
            to get started.
          </p>
        </div>
      )}
      ...
      {clips.map((clip, index) => (
        <div
          ...
          className="flex items-center gap-3 px-3 py-2.5 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg hover:shadow-sm transition-shadow cursor-grab active:cursor-grabbing"
        >
          {/* Drag handle */}
          <span className="text-gray-300 dark:text-gray-600 shrink-0 cursor-grab" title="Drag to reorder">
            ...
            {editingId === clip._id ? (
              <div className="space-y-2">
                <input
                  ...
                  className="w-full px-2 py-1 text-[13px] bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 border border-gray-300 dark:border-gray-600 rounded focus:outline-none focus:border-gray-400"
                  autoFocus
                  onKeyDown={(e) => {
